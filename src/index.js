...
module.exports = () => ({
    ...
    reportFixtureStart: async function reportFixtureStart (name) {
    ...
    reportTestDone: async function reportTestDone (name, testRunInfo) {
        ...
        await this.compileTestTable(name, testRunInfo, hasErr, result);
        if (hasErr)
            await this.compileErrors(name, testRunInfo);


        this.currentTestNumber += 1;
    },

    compileErrors: async function compileErrors (name, testRunInfo) {
    ...
    compileTestTable: async function compileTestTable (name, testRunInfo, hasErr, result) {
        if (hasErr)
    ...
    reportTaskDone: async function reportTaskDone (endTime, passed /* , warnings */) {
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right">
                <li><a href="/debug">Screenshots</a></li>
              </ul>
            </div><!-- /.navbar-collapse -->
          </div>
      </nav>
